...
--
-- Dumping data for table `tbl_chitietdh`
--

INSERT INTO `tbl_chitietdh` (`id_dh`, `id_product`, `price`, `soluong`) VALUES
(10, 2, 720000000, 1),
(10, 1, 700000000, 1),
(10, 5, 620000000, 1),
(11, 1, 700000000, 1);
...
INSERT INTO `tbl_comment` (`id`, `username`, `msg`, `date`, `id_product`) VALUES
(6, 'user1001', 'ss', '19/10/2022', 4),
(7, 'user1001', 'san pham 1', '19/10/2022', 1),
(8, 'user1001', 'mắc quá vậy', '19/10/2022', 2),
(11, '', 'test', '21/10/2022', 1),
(12, 'user1001', 'xe đẹp thật', '21/10/2022', 3),
(18, 'user1001', 'mitsubishi', '21/10/2022', 6),
(19, 'user1001', 'asd', '21/10/2022', 6),
(20, 'user1001', 'i love blue', '21/10/2022', 8),
(21, 'user1001', 'kaka done', '21/10/2022', 8),
(22, 'user1001', 'Cũng được', '21/10/2022', 9),
(24, 'user2002', 'mắc đầu, thấy rẻ mà', '21/10/2022', 2),
(25, 'user1001', 'hehe', '21/10/2022', 2),
(26, 'user1001', 'xe chạy sẽ mát lắm đây', '21/10/2022', 7),
(30, 'user1001', 'test', '29/10/2022', 4),
(31, 'user1001', 'test', '29/10/2022', 4),
(32, 'user1001', 'haha', '29/10/2022', 2),
(33, 'user1001', 'haha', '29/10/2022', 2),
(34, 'user1001', 'hello', '04/11/2022', 7),
(35, 'user1001', 'alo', '04/11/2022', 2),
(36, 'user1001', 'Xe đẹp', '04/11/2022', 2),
(37, 'user1001', 'thử', '04/11/2022', 4);
...
INSERT INTO `tbl_donhang` (`id`, `id_user`, `thanhtien`, `date`, `status`) VALUES
(10, 18, 2040000000, '08/11/2022', b'1'),
(11, 18, 700000000, '08/11/2022', b'0');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_maker`
--

CREATE TABLE `tbl_maker` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `tbl_maker`
--

INSERT INTO `tbl_maker` (`id`, `name`, `state`) VALUES
(1, 'Honda', b'1'),
(2, 'Ford', b'1'),
(3, 'Kia', b'1'),
(4, 'Volkswagen', b'1'),
...
INSERT INTO `tbl_product` (`id`, `name`, `price`, `desc`, `img`, `id_maker`, `time`, `state`) VALUES
(1, 'Honda Civic Type R', 700000000, '                                                                                                                                                                                                                                                                                                                    Successful on the track and revered by driving enthusiasts around the world, the all-new 2023 Civic Type R is more powerful than ever, featuring a turbocharged 2.0-liter, 315-horsepower* engine mated to a precise six-speed manual transmission.\r\n                    \r\n                    \r\n                    \r\n                    \r\n                    \r\n                    \r\n                    \r\n                    \r\n                    \r\n                    \r\n                    \r\n                    \r\n                ', 'https://www.cstatic-images.com/car-pictures/xl/usc90hoc174a021001.png', 1, 'Mới', b'1'),
...
(1, 'Clone_Akat', 'c4ca4238a0b923820dcc509a6f75849b', 'cmstbita356@gmail.com', 1),
(18, 'user1001', 'c4ca4238a0b923820dcc509a6f75849b', 'cmstbita356@gmail.com', 2),
(19, 'user2002', 'c4ca4238a0b923820dcc509a6f75849b', '1@gmail.com', 2),
(20, 'user1111', 'c4ca4238a0b923820dcc509a6f75849b', '1@gmail.com', 2),
(21, '31201024420', 'c4ca4238a0b923820dcc509a6f75849b', 'cmstbita356@gmail.com', 1);
...
--
-- AUTO_INCREMENT for table `tbl_maker`
--
ALTER TABLE `tbl_maker`
