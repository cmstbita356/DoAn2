...
<?php
    if(isset($_GET['msg']))
    {
        ...
        if($msg == "dk_notduplicate")
        {
            $errormsg = "Mật khẩu không trùng khớp";
        }
        if($msg == "dk_validatelenup")
        {
            $errormsg = "Username không đủ độ dài cho phép từ 5->30";
        }
        if($msg == "dk_validateemail")
        {
            $errormsg = "Email không hợp lệ";
        }
        if($msg == "dk_existusername")
        {
...
<body>
    <div id="container">
        ...
        <div id="content-dangky">
            ...
            <form id="form-dangky" action="xulydangky.php" method="post">
                <h1 style="text-align:center; padding-top: 20px;">Đăng ký</h1>
                <div id="dk_errormsg">
                    <?php 
                    if(isset($errormsg)) 
                    {
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="password1" name="password1" placeholder="Nhập mật khẩu vào đây ">
                </div>
                <div class="form-group">
                    <label for="password2">Nhập lại password: </label><br>
                    <input type="password" id="password2" name="password2" placeholder="Nhập lại mật khẩu vào đây ">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <input id="submit-dk" type="submit" Value="Đăng ký">
                </div>
...
<style>
    ...
    #form-dangky .form-group input:focus
    {
